...
exports.run = async(client, message, args, author, victim) => {
    ...
    if (!victim.voice.channel) return message.channel.send(shx.setDescription(`Belirttiğin Kişi herhangi bir ses kanalında değil.`)).then(msg => msg.delete({timeout: 5000}), message.react(emoji.luxer_red))
    ...
    if (reaction.emoji.id === emoji.luxer_green) {
